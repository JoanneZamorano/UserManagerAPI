...
| Prueba | Resultado |
| --- | --- |
| Login correcto con USER | ![Imagen](./images/dia34_1.png) |
| Login correcto con ADMIN |  ![Imagen](./images/dia34_2.png) |
| Password incorrecta | ![Imagen](./images/dia34_3.png) |
| Email inexistente | ![Imagen](./images/dia34_4.png) |
| Usuario inactivo | ![Imagen](./images/dia34_5.png) |
| Email inválido | ![Imagen](./images/dia34_6.png) |
| Password vacía | ![Imagen](./images/dia34_7.png) |
| La respuesta no devuelve passwordHash | No aparece |
| `npm run build` funciona | ![Imagen](./images/dia34_9.png) |x