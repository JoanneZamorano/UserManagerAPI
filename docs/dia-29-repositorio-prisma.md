...
| --- | --- | --- |
| `findAllUsers` | Obtener todos los usuarios | ![Imagen](./images/dia29_1.png) |
| `findActiveUsers` | Obtener usuarios activos | ![Imagen](./images/dia29_2.png) |
| `findUserById` | Buscar usuario por ID | 200 OK: ![Imagen](./images/dia29_3.png) 404 Not Found: ![Imagen](./images/dia29_4.png) 400 Bad Request: ![Imagen](./images/dia29_5.png) |
| `findUserByEmail` | Buscar usuario por email |
| `createUser` | Crear usuario | 201 Created: ![Imagen](./images/dia29_6.png) EMAIL REPETIDO: ![Imagen](./images/dia29_7.png) |

Comprobación en Prisma y Posgres:
![Imagen](./images/dia29_8.png) 
