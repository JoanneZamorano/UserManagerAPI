...
| Servicio | Responsabilidad | Captura |
| --- | --- | --- |
| `getUsersService` | Obtener todos los usuarios | ![Imagen](./images/dia28_1.png) |
| `getActiveUsersService` | Obtener usuarios activos | ![Imagen](./images/dia28_2.png) |
| `getUserByIdService` | Buscar un usuario por ID | 200 OK: ![Imagen](./images/dia28_3.png) 404 Not Found: ![Imagen](./images/dia28_4.png) 400 Bad Request: ![Imagen](./images/dia28_5.png) |
| `createDebugUserService` | Validar y crear un usuario temporal | 201 Created: ![Imagen](./images/dia28_6.png) EMAIL REPETIDO: ![Imagen](./images/dia28_7.png) EMAIL SIN FORMATO: ![Imagen](./images/dia28_8.png) PASSWORD CORTA: ![Imagen](./images/dia28_9.png) |
